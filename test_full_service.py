...
class FullTestService(win32serviceutil.ServiceFramework):
    _svc_name_ = "FullTestService"
    _svc_display_name_ = "Full Test Service"
    _svc_description_ = "Full test with all imports"
