...
Section "MainSection" SEC01
  ...
  ; ✅ 注册注销脚本（注销时也清理路由器）
  DetailPrint "Registering GPO logoff script..."
  ...
  DetailPrint "GPO logoff script registered!"
...
Section Uninstall
  ...
  ; ✅ 删除GPO注销脚本
  DetailPrint "Deleting GPO logoff script..."
  DeleteRegKey HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Group Policy\Scripts\Logoff\0\0"
