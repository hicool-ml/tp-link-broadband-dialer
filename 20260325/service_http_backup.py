...
# 注意：HTTP清理器和配置管理器采用延迟导入，避免启动时卡顿
...
class TPLinkCleanupServiceHTTP(win32serviceutil.ServiceFramework):
    ...
    def SvcShutdown(self):
        ...
        self.logger.info("=" * 60)
        self.logger.info("[ALERT] 收到系统关机通知！")
        self.logger.info("=" * 60)
...
def install_service():
    ...
    try:
        ...
        win32serviceutil.InstallService(
            ...
            serviceName=TPLinkCleanupServiceHTTP._svc_name_,
            displayName=TPLinkCleanupServiceHTTP._svc_display_name_,
