...
; Define Chinese strings for desktop shortcut
LangString DESKTOP_SHORTCUT ${LANG_SIMPCHINESE} "宽带拨号"
...
Section "Main Program" SecMain
  ...
  ; Shortcuts
  CreateShortcut "$DESKTOP\$(DESKTOP_SHORTCUT).lnk" "$INSTDIR\broadband_dialer.exe"
