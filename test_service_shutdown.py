    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                logger.info(f"✅ 浏览器: {executable_path}")
...
if __name__ == "__main__":
    logger.info("\n🧪 关机清理功能测试")
    logger.info("这个测试会模拟关机时的清理操作\n")

    success = test_shutdown_cleanup()
